...
const locales = {
  en: {
    ...
    invoice_warning_10_extended: '⚠️ *Warning:* Your Litecoin payment reservation for *{name}* will expire soon (in {minutes} minutes, at {time} CET/CEST).\n\nThis reservation has already been extended and cannot be extended further.',
  ...
  de: {
    ...
    invoice_warning_10_extended: '⚠️ *Achtung:* Deine Litecoin-Zahlungsreservierung für *{name}* läuft in Kürze ab (in {minutes} Min., um {time} Uhr MEZ/MESZ).\n\nDiese Reservierung wurde bereits verlängert und kann nicht weiter verlängert werden.',
  ...
  ru: {
    ...
    invoice_warning_10_extended: '⚠️ *Внимание:* Ваше бронирование адреса для оплаты Litecoin для *{name}* скоро истечет (через {minutes} мин, в {time} CET/CEST).\n\nЭто бронирование уже было продлено и больше не может быть продлено.',
